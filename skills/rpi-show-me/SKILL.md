---
name: rpi-show-me
description: Only use when the user explicitly invokes /rpi-show-me. Create visual explanatory artifacts.
---
...
2. If an artifact number is needed, call hl_next_artifact_number and use the returned number in NN-visual-note-short-slug.md.
3. Read references/show_me_template.md and draft the artifact in that shape.
...
6. Read references/show_me_final_answer.md and answer using that structure exactly. The final answer must end with one fenced text block containing /rpi-show-me.
