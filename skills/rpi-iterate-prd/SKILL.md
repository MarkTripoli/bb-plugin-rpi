...
description: Only use when the user explicitly invokes /rpi-iterate-prd. Revise a PRD.
---
...
2. If an artifact number is needed, call hl_next_artifact_number and use the returned number in NN-prd-short-slug.md.
3. Read references/prd_template.md and draft the artifact in that shape.
...
6. Read references/prd_final_answer.md and answer using that structure exactly. The final answer must end with one fenced text block containing /rpi-create-tdd.
