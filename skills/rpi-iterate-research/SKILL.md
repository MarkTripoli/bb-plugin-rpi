...
description: Only use when the user explicitly invokes /rpi-iterate-research. Revise descriptive research.
---
...
2. If an artifact number is needed, call hl_next_artifact_number and use the returned number in NN-research-short-slug.md.
3. Read references/research_template.md and draft the artifact in that shape.
...
6. Read references/research_final_answer.md and answer using that structure exactly. The final answer must end with one fenced text block containing /rpi-create-design-discussion.

## Rules

- Keep research descriptive. Do not recommend a design, rank options, or reveal the implementation intent.
