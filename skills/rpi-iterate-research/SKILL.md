...
6. **Update the user**
   ...
   Respond using that template only. Include the artifact directive. The final response must end with exactly one fenced `text` block containing `/rpi-create-design-discussion`.
